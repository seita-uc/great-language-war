    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            p5.background(255);
            (0, _utils.pieChart)(p5, canvasHeight - 50);
            p5.people.sort(function (a, b) {
              return a.ey - b.ey;
            });

            for (i = 0; i < p5.people.length; i++) {
              p5.people[i].move();
            }
...
},{"./utils.js":3,"babel-polyfill":4}],2:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
function () {
  function Person(p5, isPlayer, language) {
  ...
  _createClass(Person, [{
    ...
    value: function show() {
      ...
      p5.image(this.currentState, p5.mouseX, p5.mouseY, p5.personSize, p5.personSize);
      this.px = p5.mouseX;
      this.py = p5.mouseY;
      this.ex = p5.mouseX;
      this.ey = p5.mouseY;
      ...
      for (var i = 0; i < p5.people.length; i++) {
        var speaker = p5.people[i];
        ...
        if (this.bumped(speaker) && this.lang !== speaker.lang) {
          if (!this.compareRanksOfLanguages(this.lang, speaker.lang)) {
            ...
            var propotion1 = p5.langPropotionList[this.lang];
            p5.langPropotionList[this.lang] = propotion1 + 1;
            var propotion2 = p5.langPropotionList[speaker.lang];
    ...
    value: function move() {
      ...
      p5.image(this.currentState, this.ex, this.ey, p5.personSize, p5.personSize);
    ...
    key: "updatePropotionList",
    value: function updatePropotionList(anotherLang) {
      var p5 = this.p5;
      var propotion1 = p5.langPropotionList[this.lang];
      p5.langPropotionList[this.lang] = propotion1 - 1;
      var propotion2 = p5.langPropotionList[anotherLang];
      p5.langPropotionList[anotherLang] = propotion2 + 1;
    }
  }, {
    key: "bumped",
    value: function bumped(speaker) {
      var p5 = this.p5;
      var distance = p5.dist(this.ex, this.ey, speaker.ex, speaker.ey);
    ...
    key: "compareRanksOfLanguages",
    value: function compareRanksOfLanguages(lang1, lang2) {
      var p5 = this.p5;
      var sortable = [];

      for (var lang in p5.langPropotionList) {
...
exports.craeateCanvasOfParentSize = craeateCanvasOfParentSize;
exports.initialize = initialize;
exports.langPopulationList = void 0;
...
exports.langPopulationList = langPopulationList;

function pieChart(p5, diameter) {
  var lastAngle = 0;

  for (var lang in p5.langPropotionList) {
    p5.fill(p5.langColorList[lang]);
    var propotion = p5.langPropotionList[lang];
    var fullDeg = new _bignumber["default"](360);
    var bgProp = new _bignumber["default"](propotion);
    var bgTotal = new _bignumber["default"](p5.totalSpeakersPropotion);
    var angle = fullDeg.multipliedBy(bgProp).dividedBy(bgTotal).toNumber();
    ...
    var rad = lastAngle + p5.radians(angle) / 2;
    p5.rotate(rad);
    p5.fill(0, 175);
    ...
    if (angle > 10) {
      ...
      p5.rotate(p5.PI);
      p5.textSize(40);
      p5.textAlign(p5.CENTER, p5.CENTER); //p5.text(lang, diameter/3.5, 0);
...
function craeateCanvasOfParentSize(p5, parent) {
  var canvas = p5.createCanvas(parent.clientWidth, parent.clientHeight);
...
function initialize(p5) {
  ...
  p5.startTime = 0; //TODO 100以下に人数を設定するとバグる
  ...
  p5.speak.resize(p5.personSize, p5.personSize); //p5.stand = p5.loadImage("assets/human_1.svg");
  //p5.stand.resize(p5.personSize, p5.personSize);
  ...
  for (var lang in langPopulationList) {
    p5.totalLangSpeakers += langPopulationList[lang];
  }

  p5.person = new _person.Person(p5, true, "Japanese");

  for (var _lang in langPopulationList) {
    var speakers = new _bignumber["default"](langPopulationList[_lang]);
    var total = new _bignumber["default"](p5.totalLangSpeakers);
    var maxNum = new _bignumber["default"](p5.maxPeople);
    var speakersNum = speakers.dividedBy(total).multipliedBy(maxNum).toNumber();
    p5.langPropotionList[_lang] = speakersNum;
    p5.totalSpeakersPropotion += speakersNum;
    var langColor = p5.color(p5.random(255), p5.random(255), p5.random(255));

    if (_lang == p5.person.lang) {
      langColor = p5.color(255, 255, 255);
    }

    p5.langColorList[_lang] = langColor;

    if (speakersNum > 1) {
      for (var i = 0; i < speakersNum; i++) {
        var langSpeaker = new _person.Person(p5, false, _lang);
...
},{"./person.js":2,"bignumber.js":5}],4:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":6,"core-js/shim":334,"regenerator-runtime/runtime":335}],5:[function(require,module,exports){
...
},{"../../modules/_core":28,"../../modules/core.regexp.escape":136}],7:[function(require,module,exports){
...
},{"./_cof":23}],9:[function(require,module,exports){
...
},{"./_hide":48,"./_wks":134}],10:[function(require,module,exports){
'use strict';
...
},{"./_string-at":111}],11:[function(require,module,exports){
...
},{"./_is-object":57}],13:[function(require,module,exports){
...
},{"./_a-function":7,"./_invoke":52,"./_is-object":57}],22:[function(require,module,exports){
...
},{"./_an-instance":11,"./_an-object":12,"./_array-methods":17,"./_for-of":44,"./_has":47,"./_is-object":57,"./_meta":71,"./_redefine-all":96,"./_validate-collection":131}],27:[function(require,module,exports){
'use strict';
...
},{"./_an-instance":11,"./_export":38,"./_fails":40,"./_for-of":44,"./_global":46,"./_inherit-if-required":51,"./_is-object":57,"./_iter-detect":62,"./_meta":71,"./_redefine":97,"./_redefine-all":96,"./_set-to-string-tag":106}],28:[function(require,module,exports){
...
},{"./_defined":33,"./_fails":40,"./_hide":48,"./_redefine":97,"./_regexp-exec":99,"./_wks":134,"./es6.regexp.exec":231}],42:[function(require,module,exports){
'use strict';
...
},{"./_shared":108}],46:[function(require,module,exports){
...
},{"./_cof":23}],54:[function(require,module,exports){
...
},{"./_export":38,"./_hide":48,"./_iter-create":60,"./_iterators":64,"./_library":65,"./_object-gpo":84,"./_redefine":97,"./_set-to-string-tag":106,"./_wks":134}],62:[function(require,module,exports){
var ITERATOR = require('./_wks')('iterator');
...
},{"./_wks":134}],63:[function(require,module,exports){
...
},{"./_fails":40,"./_has":47,"./_is-object":57,"./_object-dp":77,"./_uid":129}],72:[function(require,module,exports){
...
},{"./_export":38,"./_shared":108,"./es6.map":166,"./es6.weak-map":273}],73:[function(require,module,exports){
var global = require('./_global');
...
},{"./_cof":23,"./_global":46,"./_task":118}],74:[function(require,module,exports){
'use strict';
...
},{"./_fails":40,"./_iobject":53,"./_object-gops":83,"./_object-keys":86,"./_object-pie":87,"./_to-object":124}],76:[function(require,module,exports){
...
},{"./_descriptors":34,"./_has":47,"./_ie8-dom-define":50,"./_object-pie":87,"./_property-desc":95,"./_to-iobject":122,"./_to-primitive":125}],81:[function(require,module,exports){
...
},{"./_enum-bug-keys":36,"./_object-keys-internal":85}],83:[function(require,module,exports){
...
},{"./_has":47,"./_shared-key":107,"./_to-object":124}],85:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_enum-bug-keys":36,"./_object-keys-internal":85}],87:[function(require,module,exports){
...
},{"./_an-object":12,"./_global":46,"./_object-gopn":82,"./_object-gops":83}],91:[function(require,module,exports){
...
},{"./_global":46,"./_string-trim":116,"./_string-ws":117}],92:[function(require,module,exports){
...
},{"./_global":46,"./_string-trim":116,"./_string-ws":117}],93:[function(require,module,exports){
module.exports = function (exec) {
  try {
...
},{"./_core":28,"./_function-to-string":45,"./_global":46,"./_has":47,"./_hide":48,"./_uid":129}],98:[function(require,module,exports){
'use strict';
...
},{"./_classof":22}],99:[function(require,module,exports){
'use strict';
...
},{"./_flags":42}],100:[function(require,module,exports){
...
},{"./_an-object":12,"./_ctx":30,"./_is-object":57,"./_object-gopd":80}],105:[function(require,module,exports){
'use strict';
var global = require('./_global');
var dP = require('./_object-dp');
var DESCRIPTORS = require('./_descriptors');
...
},{"./_defined":33,"./_to-integer":121}],112:[function(require,module,exports){
...
},{"./_defined":33,"./_export":38,"./_fails":40}],114:[function(require,module,exports){
...
},{"./_defined":33,"./_string-repeat":115,"./_to-length":123}],115:[function(require,module,exports){
'use strict';
var toInteger = require('./_to-integer');
var defined = require('./_defined');
...
},{"./_defined":33,"./_export":38,"./_fails":40,"./_string-ws":117}],117:[function(require,module,exports){
...
},{"./_cof":23,"./_ctx":30,"./_dom-create":35,"./_global":46,"./_html":49,"./_invoke":52}],119:[function(require,module,exports){
var toInteger = require('./_to-integer');
var max = Math.max;
var min = Math.min;
...
},{"./_an-instance":11,"./_array-fill":14,"./_descriptors":34,"./_fails":40,"./_global":46,"./_hide":48,"./_library":65,"./_object-dp":77,"./_object-gopn":82,"./_redefine-all":96,"./_set-to-string-tag":106,"./_to-index":120,"./_to-integer":121,"./_to-length":123,"./_typed":128}],128:[function(require,module,exports){
var global = require('./_global');
var hide = require('./_hide');
var uid = require('./_uid');
...
},{"./_global":46,"./_hide":48,"./_uid":129}],129:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_core":28,"./_global":46,"./_library":65,"./_object-dp":77,"./_wks-ext":133}],133:[function(require,module,exports){
...
},{"./_array-methods":17,"./_export":38,"./_strict-method":110}],139:[function(require,module,exports){
// 22.1.3.6 Array.prototype.fill(value, start = 0, end = this.length)
var $export = require('./_export');
...
},{"./_array-methods":17,"./_export":38,"./_strict-method":110}],141:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":9,"./_array-methods":17,"./_export":38}],142:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":9,"./_array-methods":17,"./_export":38}],143:[function(require,module,exports){
'use strict';
var $export = require('./_export');
...
},{"./_array-methods":17,"./_export":38,"./_strict-method":110}],144:[function(require,module,exports){
'use strict';
var ctx = require('./_ctx');
var $export = require('./_export');
var toObject = require('./_to-object');
...
},{"./_create-property":29,"./_ctx":30,"./_export":38,"./_is-array-iter":54,"./_iter-call":59,"./_iter-detect":62,"./_to-length":123,"./_to-object":124,"./core.get-iterator-method":135}],145:[function(require,module,exports){
'use strict';
var $export = require('./_export');
...
},{"./_array-includes":16,"./_export":38,"./_strict-method":110}],146:[function(require,module,exports){
...
},{"./_export":38,"./_iobject":53,"./_strict-method":110,"./_to-iobject":122}],149:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var toIObject = require('./_to-iobject');
var toInteger = require('./_to-integer');
...
},{"./_export":38,"./_strict-method":110,"./_to-integer":121,"./_to-iobject":122,"./_to-length":123}],150:[function(require,module,exports){
'use strict';
var $export = require('./_export');
...
},{"./_array-methods":17,"./_export":38,"./_strict-method":110}],151:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var createProperty = require('./_create-property');
...
},{"./_create-property":29,"./_export":38,"./_fails":40}],152:[function(require,module,exports){
'use strict';
var $export = require('./_export');
...
},{"./_array-reduce":18,"./_export":38,"./_strict-method":110}],153:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var $reduce = require('./_array-reduce');
...
},{"./_array-reduce":18,"./_export":38,"./_strict-method":110}],154:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var html = require('./_html');
var cof = require('./_cof');
...
},{"./_cof":23,"./_export":38,"./_fails":40,"./_html":49,"./_to-absolute-index":119,"./_to-length":123}],155:[function(require,module,exports){
'use strict';
var $export = require('./_export');
...
},{"./_array-methods":17,"./_export":38,"./_strict-method":110}],156:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var aFunction = require('./_a-function');
var toObject = require('./_to-object');
...
},{"./_export":38,"./_fails":40,"./_to-object":124,"./_to-primitive":125}],161:[function(require,module,exports){
...
},{"./_redefine":97}],163:[function(require,module,exports){
...
},{"./_descriptors":34,"./_object-dp":77}],166:[function(require,module,exports){
'use strict';
...
},{"./_export":38,"./_math-log1p":68}],168:[function(require,module,exports){
...
},{"./_export":38,"./_math-expm1":66}],174:[function(require,module,exports){
// 20.2.2.16 Math.fround(x)
var $export = require('./_export');
...
},{"./_export":38,"./_fails":40}],177:[function(require,module,exports){
...
},{"./_export":38,"./_fails":40,"./_math-expm1":66}],182:[function(require,module,exports){
...
},{"./_cof":23,"./_descriptors":34,"./_fails":40,"./_global":46,"./_has":47,"./_inherit-if-required":51,"./_object-create":76,"./_object-dp":77,"./_object-gopd":80,"./_object-gopn":82,"./_redefine":97,"./_string-trim":116,"./_to-primitive":125}],185:[function(require,module,exports){
...
},{"./_export":38,"./_parse-float":91}],193:[function(require,module,exports){
var $export = require('./_export');
var $parseInt = require('./_parse-int');
// 20.1.2.13 Number.parseInt(string, radix)
$export($export.S + $export.F * (Number.parseInt != $parseInt), 'Number', { parseInt: $parseInt });

},{"./_export":38,"./_parse-int":92}],194:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var toInteger = require('./_to-integer');
...
},{"./_a-number-value":8,"./_export":38,"./_fails":40,"./_string-repeat":115,"./_to-integer":121}],195:[function(require,module,exports){
'use strict';
var $export = require('./_export');
var $fails = require('./_fails');
var aNumberValue = require('./_a-number-value');
...
},{"./_an-object":12,"./_export":38,"./_fails":40,"./_object-dp":77,"./_to-primitive":125}],219:[function(require,module,exports){
...
},{"./_an-object":12,"./_export":38}],226:[function(require,module,exports){
...
},{"./_an-object":12,"./_export":38}],228:[function(require,module,exports){
...
},{"./_descriptors":34,"./_fails":40,"./_flags":42,"./_global":46,"./_inherit-if-required":51,"./_is-regexp":58,"./_object-dp":77,"./_object-gopn":82,"./_redefine":97,"./_set-species":105,"./_wks":134}],231:[function(require,module,exports){
'use strict';
var regexpExec = require('./_regexp-exec');
require('./_export')({
  target: 'RegExp',
...
},{"./_export":38,"./_regexp-exec":99}],232:[function(require,module,exports){
// 21.2.5.3 get RegExp.prototype.flags()
...
},{"./_descriptors":34,"./_flags":42,"./_object-dp":77}],233:[function(require,module,exports){
'use strict';
...
},{"./_advance-string-index":10,"./_an-object":12,"./_fix-re-wks":41,"./_regexp-exec-abstract":98,"./_to-length":123}],234:[function(require,module,exports){
'use strict';
...
},{"./_advance-string-index":10,"./_an-object":12,"./_fix-re-wks":41,"./_regexp-exec-abstract":98,"./_to-integer":121,"./_to-length":123,"./_to-object":124}],235:[function(require,module,exports){
'use strict';
...
},{"./_an-object":12,"./_fix-re-wks":41,"./_regexp-exec-abstract":98,"./_same-value":101}],236:[function(require,module,exports){
'use strict';
...
},{"./_advance-string-index":10,"./_an-object":12,"./_fails":40,"./_fix-re-wks":41,"./_is-regexp":58,"./_regexp-exec":99,"./_regexp-exec-abstract":98,"./_species-constructor":109,"./_to-length":123}],237:[function(require,module,exports){
'use strict';
...
},{"./_an-object":12,"./_descriptors":34,"./_fails":40,"./_flags":42,"./_redefine":97,"./es6.regexp.flags":232}],238:[function(require,module,exports){
'use strict';
var strong = require('./_collection-strong');
var validate = require('./_validate-collection');
var SET = 'Set';
...
},{"./_export":38,"./_fails-is-regexp":39,"./_string-context":112,"./_to-length":123}],245:[function(require,module,exports){
'use strict';
...
},{"./_export":38,"./_to-absolute-index":119}],249:[function(require,module,exports){
...
},{"./_export":38,"./_fails-is-regexp":39,"./_string-context":112}],250:[function(require,module,exports){
'use strict';
...
},{"./_export":38,"./_to-iobject":122,"./_to-length":123}],254:[function(require,module,exports){
var $export = require('./_export');
...
},{"./_export":38,"./_fails-is-regexp":39,"./_string-context":112,"./_to-length":123}],257:[function(require,module,exports){
'use strict';
...
},{"./_an-object":12,"./_export":38,"./_fails":40,"./_global":46,"./_is-object":57,"./_set-species":105,"./_species-constructor":109,"./_to-absolute-index":119,"./_to-length":123,"./_typed":128,"./_typed-buffer":127}],263:[function(require,module,exports){
var $export = require('./_export');
...
},{"./_array-methods":17,"./_collection":27,"./_collection-weak":26,"./_global":46,"./_is-object":57,"./_meta":71,"./_object-assign":75,"./_redefine":97,"./_validate-collection":131}],274:[function(require,module,exports){
'use strict';
var weak = require('./_collection-weak');
var validate = require('./_validate-collection');
...
},{"./_a-function":7,"./_an-instance":11,"./_an-object":12,"./_core":28,"./_export":38,"./_for-of":44,"./_global":46,"./_hide":48,"./_microtask":73,"./_redefine-all":96,"./_set-species":105,"./_wks":134}],304:[function(require,module,exports){
...
},{"./_core":28,"./_export":38,"./_global":46,"./_promise-resolve":94,"./_species-constructor":109}],305:[function(require,module,exports){
'use strict';
...
},{"./_an-object":12,"./_metadata":72}],308:[function(require,module,exports){
...
},{"./_an-object":12,"./_array-from-iterable":15,"./_metadata":72,"./_object-gpo":84,"./es6.set":238}],309:[function(require,module,exports){
var metadata = require('./_metadata');
var anObject = require('./_an-object');
var getPrototypeOf = require('./_object-gpo');
...
},{"./_an-object":12,"./_metadata":72}],311:[function(require,module,exports){
var metadata = require('./_metadata');
var anObject = require('./_an-object');
var ordinaryGetOwnMetadata = metadata.get;
var toMetaKey = metadata.key;
...
},{"./_defined":33,"./_export":38,"./_flags":42,"./_is-regexp":58,"./_iter-create":60,"./_to-length":123}],320:[function(require,module,exports){
'use strict';
// https://github.com/tc39/proposal-string-pad-start-end
var $export = require('./_export');
...
},{"./_export":38,"./_global":46,"./_user-agent":130}],334:[function(require,module,exports){
