      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            for (lang in p5.langPropotionList) {
              console.log(lang, p5.langPropotionList[lang]);
            }
...
function pieChart(p5, diameter) {
  ...
  for (var lang in p5.langPropotionList) {
    ...
    var rad = lastAngle + p5.radians(angle);
    p5.rotate(rad);
    p5.fill(0);
...
function initialize(p5) {
  ...
  for (var _lang in langPopulationList) {
    ...
    var maxNum = new _bignumber["default"](p5.maxPeople); //const propotion = speakers
    //.dividedBy(total)
