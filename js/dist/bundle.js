...
var sketch = function sketch(p5) {
  ...
  regeneratorRuntime.mark(function _callee() {
    var body, imgPath, i, x, y, xspeed, yspeed, masateru;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            imgPath = "../../processing/images/block.png";

            for (i = 0; i < 5; i++) {
              x = p5.random(0, canvasWidth);
              y = p5.random(0, canvasHeight);
              xspeed = p5.random(-15, 15);
              yspeed = p5.random(-15, 15);
              masateru = new Person(p5, imgPath, x, y, xspeed, yspeed);
  ...
  p5.mousePressed = function () {
    for (var i = 0; i < masaterus.length; i++) {
      var size = void 0;
...
/*#__PURE__*/
function () {
  function Person(p5, imgPath, x, y, xspeed, yspeed) {
...
},{"core-js/fn/regexp/escape":3,"core-js/shim":331,"regenerator-runtime/runtime":332}],3:[function(require,module,exports){
